...
function createEternalUrlWindow(url){
    var external = new BrowserWindow({width: 1680, height: 960,icon:path.join(__dirname, 'images/logo.png')});
...
function createWindow () {
    ...
    mainWindow = new BrowserWindow({width: 1680, height: 960,icon:path.join(__dirname, 'images/logo.png')});
    //mainWindow.maximize();
