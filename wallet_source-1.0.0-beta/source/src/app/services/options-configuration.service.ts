...
export class OptionsConfigurationService {
  ...
  constructor(private commonService: CommonService, private accountService: AccountService, private optionService: OptionService, private sessionStorageService: SessionStorageService) { }
